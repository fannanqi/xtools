...
#include "../../../Source/SystemTrayIcon.h"
...
QT_MOC_LITERAL(1, 15, 10), // "invokeExit"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 20) // "invokeShowMainWindow"

    },
    "SystemTrayIcon\0invokeExit\0\0"
    "invokeShowMainWindow"
};
...
void SystemTrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->invokeExit(); break;
        case 1: _t->invokeShowMainWindow(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTrayIcon::invokeExit)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SystemTrayIcon::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTrayIcon::invokeShowMainWindow)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SystemTrayIcon::invokeExit()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SystemTrayIcon::invokeShowMainWindow()
{
